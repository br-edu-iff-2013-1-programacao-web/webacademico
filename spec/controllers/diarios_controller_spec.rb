...
describe DiariosController do
  ...
  let(:valid_attributes) { { "ano" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved diario as @diario" do
        ...
        post :create, {:diario => { "ano" => "invalid value" }}, valid_session
        assigns(:diario).should be_a_new(Diario)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested diario" do
        ...
        Diario.any_instance.should_receive(:update_attributes).with({ "ano" => "MyString" })
        put :update, {:id => diario.to_param, :diario => { "ano" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the diario as @diario" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Diario.any_instance.stub(:save).and_return(false)
        put :update, {:id => diario.to_param, :diario => { "ano" => "invalid value" }}, valid_session
        assigns(:diario).should eq(diario)
      end
