  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved disciplina as @disciplina" do
        ...
        post :create, {:disciplina => { "nome" => "invalid value" }}, valid_session
        assigns(:disciplina).should be_a_new(Disciplina)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested disciplina" do
        ...
        Disciplina.any_instance.should_receive(:update_attributes).with({ "nome" => "MyString" })
        put :update, {:id => disciplina.to_param, :disciplina => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the disciplina as @disciplina" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Disciplina.any_instance.stub(:save).and_return(false)
        put :update, {:id => disciplina.to_param, :disciplina => { "nome" => "invalid value" }}, valid_session
        assigns(:disciplina).should eq(disciplina)
      end
