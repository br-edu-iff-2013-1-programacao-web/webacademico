  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved grade as @grade" do
        ...
        post :create, {:grade => { "periodo" => "invalid value" }}, valid_session
        assigns(:grade).should be_a_new(Grade)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested grade" do
        ...
        Grade.any_instance.should_receive(:update_attributes).with({ "periodo" => "MyString" })
        put :update, {:id => grade.to_param, :grade => { "periodo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the grade as @grade" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Grade.any_instance.stub(:save).and_return(false)
        put :update, {:id => grade.to_param, :grade => { "periodo" => "invalid value" }}, valid_session
        assigns(:grade).should eq(grade)
      end
